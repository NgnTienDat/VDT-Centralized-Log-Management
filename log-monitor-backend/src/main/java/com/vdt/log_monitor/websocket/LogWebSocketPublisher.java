 ...
 * /topic/logs.{env}.{service}.{level} → filter cụ thể, VD:
 * /topic/logs.dev.error
 * /topic/logs.{env}.{service}.all → tất cả level của 1 env
 ...
 *
 * Ví dụ:
 * Client A subscribe /topic/logs.dev.logs-service.error → chỉ nhận ERROR của
 * DEV
