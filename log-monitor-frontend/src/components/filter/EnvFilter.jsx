...
export default function EnvFilter({ value, onChange, isDark }) {
    const inactiveClass = isDark
        ...
        : "bg-transparent border-slate-300 text-slate-600 hover:border-slate-400 hover:text-slate-800";
    ...
    return (
        <div className="flex items-center gap-2 flex-wrap">
            <span className="text-[11px] tracking-widest text-slate-700 uppercase">Env:</span>
